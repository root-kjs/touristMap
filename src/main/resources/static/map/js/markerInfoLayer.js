...
// 소개정보조회(업체 공통상세정보) https://apis.data.go.kr/B551011/KorService2/detailIntro2? 상세소개 쉬는날, 개장기간 등 내역을 조회하는 기능
...
export const markerInfoLayer = async( value, marker ) => { //console.log("지도마커 클릭시, 상세업체정보 출력하기");
        ...
        let detailInfo = data.response.body.items.item;
        ...
        <div class="modal_box">
            ...
            <div class="modal_img_box">
                ...
                <div class="modal_content_outline">
                    <h3>${value.title}</h3><span>${value.contenttypeid}</span>
            ...
            <div class="modal_content">
                ...
                <ul>
                    ...
                    <li><b>주차여부</b>${detailInfo.parking}</li>
                    <li><b>휴무일</b>${detailInfo.restdate}</li>
                    <li><b>이용시간</b>${detailInfo.usetime}</li>
                    <li><b>문의및안내</b>${detailInfo.infocenter}</li>
                    <li><b>이용시간</b>${detailInfo.usetime}</li>
                </ul>
                <h4>사진이미지</h4>
