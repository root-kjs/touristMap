...
public class LocationApiService {
    ...
    public List<Map<String, Object>> schedulLocationList2() {
        try {
            String extraParams = URLEncoder.encode("numOfRows", "UTF-8") + "=" + "10";// 한 페이지 결과 수 : 일단 최대값 설정함(250906기준 전국관광 정보 데이터수 : 50,204개)
            ...
            extraParams += "&" + URLEncoder.encode("radius", "UTF-8") + "=" + "1000"; // *필수입력 파라미터: 거리반경(단위:m) , Max값 20000m=20Km
    ...
    /* [1-2/패치] 위치기반 관광정보(locationBasedList2)  > 스케쥴링으로 저장된 자바 객체 데이터 */
